...
## ${sectionTitle}`,
  ...
  return (
    <div className="sections">
      <h3 className="border-transparent text-blue-700 whitespace-nowrap px-1 border-b-2 font-medium text-sm focus:outline-none">
            ...
            alphabetizedSectionSlugs.map((s) => {
              ...
              if (template) {
                return (
                  <li key={s}>
                    <button
                      className="flex items-center block w-full h-full py-2 pl-3 pr-6 bg-white rounded-md shadow cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                      type="button"
