                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="my-4">
                      <input
                        ...
                        className="shadow-sm p-2 focus:outline-none focus:ring-2 focus:ring-blue-700 block w-full sm:text-sm border border-gray-300 rounded-md"
                        placeholder="Section Title"
                      />
                    </div>
                  </div>
                </div>
                <div className="mt-5 sm:mt-6 font-semibold flex gap-x-2">
                  <button
                    type="button"
                    className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-700 text-base font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 sm:col-start-2 sm:text-sm disabled:opacity-50"
                    disabled={!title}
                  ...
                  <button
                    type="button"
                    className="mt-3 w-full inline-flex justify-center rounded-md border bg-red-500 border-gray-300  text-white shadow-sm px-4 py-2  text-base font-medium  hover:bg-red-600 focus:outline-none    sm:mt-0 sm:col-start-1 sm:text-sm"
