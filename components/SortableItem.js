...
export function SortableItem(props) {
  ...
  return (
    ...
    >
      <button
        type="button"
        className="mr-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400"
        {...listeners}
      >
      ...
      {props?.section?.slug === props.focusesSectionSlug && (
        <>
          <button
            className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 absolute right-8"
            type="button"
          ...
          <button
            className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 absolute right-2"
            type="button"
